...
const testimonialsData = [
  {
    ...
    testimonial: 'Amy transformed my daughter\'s approach to English Literature. She went from a Grade 5 to achieving a Grade 8 in her GCSEs. The examiner insights were invaluable!',
    rating: 5,
    studentInitials: 'EM',
  ...
  },
  {
    ...
    name: 'David Chen',
    role: 'IB Student',
    testimonial: 'The academic writing support was exactly what I needed. Amy helped me develop a sophisticated writing style that impressed my teachers. I achieved a 7 in English!',
    rating: 5,
    studentInitials: 'DC',
    course: 'IB English',
  ...
  },
  {
    ...
    testimonial: 'Moving from Spain, my son struggled with academic English. Amy\'s patient approach and cultural understanding made all the difference. He\'s now thriving at university!',
    rating: 5,
    studentInitials: 'JG',
  ...
  },
  {
    ...
    testimonial: 'Amy\'s examiner perspective gave me a huge advantage. She showed me exactly what examiners look for and how to structure perfect answers. Got my A* and into Oxford!',
    rating: 5,
    studentInitials: 'JT',
  ...
  },
  {
    ...
    testimonial: 'My daughter was falling behind due to lack of confidence. Amy built her up gradually, and now she actively participates in class. The personalized approach really works!',
    rating: 5,
    studentInitials: 'AP',
    course: 'KS3 English',
  ...
  },
  {
    ...
    testimonial: 'I needed to improve my business English for presentations. Amy\'s lessons were practical and immediately applicable. My confidence in meetings has soared!',
    rating: 5,
    studentInitials: 'RK',
